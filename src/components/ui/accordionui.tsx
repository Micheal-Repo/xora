...
export type AccordionContextType = {
  ...
  variants?: {
    expanded: Variant; collapsed: Variant
  };
};
...
function AccordionProvider({
  ...
  const [internalExpandedValue,
    setInternalExpandedValue] =
  useState < React.Key | null > (null);

  const expandedValue =
  externalExpandedValue !== undefined
  ? externalExpandedValue: internalExpandedValue;
...
function AccordionContent({
  ...
  const combinedVariants = {
    expanded: {
      ...BASE_VARIANTS.expanded, ...variants?.expanded
    },
    collapsed: {
      ...BASE_VARIANTS.collapsed, ...variants?.collapsed
    },
  };
